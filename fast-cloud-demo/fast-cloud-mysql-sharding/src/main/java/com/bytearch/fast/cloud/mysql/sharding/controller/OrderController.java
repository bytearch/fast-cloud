...
import com.bytearch.fast.cloud.mysql.sharding.dao.OrderWriteWrapDao;
...
public class OrderController {
    ...
    @Autowired
    OrderWriteWrapDao orderWriteWrapDao;
    ...
    public ResponseResult create(@RequestParam(name = "userId") Integer userId) {
        ...
        int ret = orderWriteWrapDao.insertOrder(orderEntity);
        if( ret > 0) {

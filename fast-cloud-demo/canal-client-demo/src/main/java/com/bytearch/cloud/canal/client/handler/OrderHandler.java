...
@CanalHandler(value = "orderInfoHandler", destination = "simpleInstance", schema = {"order_center"}, table = {"order_info"}, eventType = {CanalEntry.EventType.UPDATE, CanalEntry.EventType.INSERT,CanalEntry.EventType.DELETE})
